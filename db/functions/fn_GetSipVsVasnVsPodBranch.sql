...
/****** Object:  UserDefinedFunction [Entt].[fn_GetSipVsVasnVsPodBranch]    Script Date: 03/05/2018 4:59:34 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [Entt].[fn_GetSipVsVasnVsPodBranch](@date date,@branchCode nvarchar(10))  
RETURNS TABLE  
AS  
RETURN 
