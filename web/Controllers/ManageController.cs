...
namespace Entt.Ers.Controllers
{
    ...
    public class ManageController : ApplicationBaseController
    {
        ...
        public async Task<ActionResult> AddUser(RegisterViewModel model)
        {
            ...
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, FullName = model.FullName, BranchCode = model.BranchCode };
        ...
        {
            var user = m_context.Users.SingleOrDefault(u => u.Id == id);
            if (null == user)
                return RedirectToAction("Unauthorized", "Action");
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> UserInfo(UpdateUserViewModel model)
        {
            if (ModelState.IsValid)
            {
