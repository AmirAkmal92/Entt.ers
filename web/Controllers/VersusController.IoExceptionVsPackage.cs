...
namespace Entt.Ers.Controllers
{
    ...
    {
        public ActionResult IoExceptionVsPackage()
        {
        ...
        public ActionResult IoExceptionVsPackage(PrefixReportViewModel model)
        {
            var reportViewer = ReportEngine.Create();
            ...
            if (ModelState.IsValid)
            {
                ...
                dataset = model.SelectedBranch == "All" ?
                    m_enttContext.GetIoExceptionVsPackageReportDataSet(model.ReportDate, day) :
                    m_enttContext.GetIoExceptionVsPackageBranchReportDataSet(model.ReportDate, day, model.SelectedBranch);
                reportViewer.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"Reports\Versus\IoExceptionVsPackage.rdlc";
        ...
        public ActionResult IoExceptionVsPackageDetails(string branchCode, double date, string day = "7")
        {
            ...
            var dataset = m_enttContext.GetIoExceptionVsPackageDetailsReportDataSet(reportDate.Date, int.Parse(day), branchCode);
            reportViewer.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"Reports\Versus\IoExceptionVsPackageDetails.rdlc";
            var parameters = new List<ReportParameter>
                {
