...
namespace Entt.Ers.Controllers
{
    public partial class VersusController
    {
        ...
        public ActionResult HipVsHopDetails(string branchCode, double date, string day = "7")
        {
            ...
            var dataset = m_enttContext.GetHipVsHopDetailsReportDataSet(reportDate.Date, int.Parse(day), branchCode);
            reportViewer.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"Reports\Versus\HipVsHopDetails.rdlc";
            var parameters = new List<ReportParameter>
                {
